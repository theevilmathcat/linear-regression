...
- \( \sum XY = (60×400)+(70×500)+(80×550)+(90×600)+(100×650) = 227000 \)
...
\[
SS_{XX} = 33000 - \frac{400^2}{5} = 33000 - 32000 = 1000
\]

\[
SS_{YY} = 1502500 - \frac{2700^2}{5} = 1502500 - 1458000 = 44500
\]

\[
SS_{XY} = 227000 - \frac{400 \times 2700}{5} = 227000 - 216000 = 11000
\]
...
\[
b_0 = \bar{Y} - b_1\bar{X} = 540 - (11 \times 80) = -340
\]
...
\[
MSE = \frac{SSE}{n-2} = \frac{26000}{3} = 8666.67
\]

\[
s = \sqrt{MSE} = \sqrt{8666.67} = 93.10
\]
...
\[
s_{b_1} = \frac{s}{\sqrt{SS_{XX}}} = \frac{93.10}{\sqrt{1000}} = 2.944
\]

### Test Statistic

\[
t = \frac{b_1 - 0}{s_{b_1}} = \frac{11}{2.944} = 3.736
\]
...
\[
= 11 \pm (3.182 \times 2.944)
\]

\[
= 11 \pm 9.37 = (1.63, 20.37)
\]
...
\[
R^2 = \frac{SSR}{SST} = \frac{18500}{44500} = 0.4157
\]
...
## 13. Five Key Quantities for Testing the Slope
